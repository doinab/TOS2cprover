...
class CParser(PLYParser):    
    ...
    def p_function_definition_3(self, p):
        """ function_definition : declaration_specifiers declarator storage_class_specifier declaration_list_opt compound_statement
        """
        self._add_declaration_specifier(p[1], p[3], 'storage')
        spec = p[1]
    ...
    def p_storage_class_specifier(self, p):
        """ storage_class_specifier : AUTO
                                    ...
                                    | __INLINE
                                    | __ATTRIBUTE_PACKED
                                    | __ATTRIBUTE_INTERRUPT INT_CONST_DEC
        """
    ...
    def p_struct_or_union_specifier_3(self, p):
        """ struct_or_union_specifier : struct_or_union LBRACE struct_declaration_list RBRACE __ATTRIBUTE_PACKED
        """
        klass = self._select_struct_union_class(p[1])
        p[0] = klass(
            name=None,
    ...
    def p_struct_or_union_specifier_5(self, p):
        """ struct_or_union_specifier   : struct_or_union ID LBRACE struct_declaration_list RBRACE __ATTRIBUTE_PACKED
                                        | struct_or_union TYPEID LBRACE struct_declaration_list RBRACE __ATTRIBUTE_PACKED
        """
        klass = self._select_struct_union_class(p[1])
        p[0] = klass(
            name=p[2],
    ...
    def p_struct_or_union_specifier_6(self, p):
        """ struct_or_union_specifier   : struct_or_union ID LBRACE RBRACE
                                        | struct_or_union TYPEID LBRACE RBRACE
        """
        klass = self._select_struct_union_class(p[1])
        p[0] = klass(
            name=p[2],
    ...
    def p_struct_declaration_1(self, p):
        ...
        for struct_decl in p[2]:
            decl = c_ast.Decl(
                ...
                coord=0) # was: struct_decl['decl'].coord()
    ...
    def p_direct_declarator_5(self, p):
        """ direct_declarator   : direct_declarator LPAREN parameter_type_list RPAREN __ATTRIBUTE_INTERRUPT INT_CONST_DEC
                                | direct_declarator LPAREN identifier_list_opt RPAREN __ATTRIBUTE_INTERRUPT INT_CONST_DEC
        """
        func = c_ast.FuncDecl(
            args=p[3],
            type=None,
    ...
    def p_direct_declarator_6(self, p):
        """ direct_declarator   : ID __ASM LPAREN STRING_LITERAL RPAREN
        """
        #print "HIT: " + p[1] + " " + p[2] + " " + p[3] + p[4] + p[5]

        p[0] = c_ast.TypeDecl(
            declname=p[1] + '@' + p[4], # dirty trick,
            type=None, 
            quals=p[4],                 # as this doesn't show up in the AST
            coord=self._coord(p.lineno(1))) 
    ...
    def p_unary_expression_4(self, p):
        """ unary_expression    : compound_statement """
        p[0] = p[1]
    ...
    def p_postfix_expression_5(self, p):
        ...
        """
        p[0] = c_ast.StructRef(None, p[1], p[2], self._coord(p.lineno(1)))
