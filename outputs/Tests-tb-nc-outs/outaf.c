...
msp430_spi_union_config_t msp430_spi_default_config = {.ubr = 0x0002, .ssel = 0x02, .clen = 1, .listen = 0, .mm = 1, .ckph = 1, .ckpl = 0, .stc = 1};
...
static void Msp430TimerP_0_Event_default_fired(uint8_t arg_0x1593680) ;
...
static void Msp430TimerP_0_Event_fired(uint8_t arg_0x1593680) ;
...
static inline void Msp430TimerP_0_Event_fired(uint8_t arg_0x1593680) 
{
  switch (arg_0x1593680) 
  {
    ...
    case 5:
      ...
      break;
    default :
      Msp430TimerP_0_Event_default_fired(arg_0x1593680);
      break;
  }
...
inline static Msp430TimerCapComP_0_cc_t Msp430TimerCapComP_0_int2CC(uint16_t x) 
{
  union Msp430TimerCapComP_0___nesc_unnamed4348  {
  uint16_t f;
...
inline static Msp430TimerCapComP_0_cc_t Msp430TimerCapComP_0_Control_getControl( void ) 
{
  return Msp430TimerCapComP_0_int2CC(_TACCTL0);
}
...
inline static Msp430TimerCapComP_1_cc_t Msp430TimerCapComP_1_int2CC(uint16_t x) 
{
  union Msp430TimerCapComP_1___nesc_unnamed4349  {
  uint16_t f;
...
inline static Msp430TimerCapComP_1_cc_t Msp430TimerCapComP_1_Control_getControl( void ) 
{
  return Msp430TimerCapComP_1_int2CC(_TACCTL1);
}
...
inline static Msp430TimerCapComP_2_cc_t Msp430TimerCapComP_2_int2CC(uint16_t x) 
{
  union Msp430TimerCapComP_2___nesc_unnamed4350  {
  uint16_t f;
...
inline static Msp430TimerCapComP_2_cc_t Msp430TimerCapComP_2_Control_getControl( void ) 
{
  return Msp430TimerCapComP_2_int2CC(_TACCTL2);
}
...
inline static void CC2420ActiveMessageP_SubBackoff_requestCongestionBackoff(message_t *msg) 
{
  CC2420ActiveMessageP_RadioBackoff_requestCongestionBackoff(__nesc_ntoh_leuint8(( cc2420_header_t * )((( uint8_t * )(msg) + ( size_t )(&_IE1->data)) - sizeof( cc2420_header_t ))->type.data), msg);
}
  ...
  ArbiterP_0_ResourceRequested_immediateRequested(ArbiterP_0_resId);
{
  ...
  {
    unsigned char __nesc_temp = FAIL;
    return __nesc_temp;
  }
}
...
{
{
  ...
  {
    unsigned char __nesc_temp = SUCCESS;
    return __nesc_temp;
  }
  }
{
  unsigned char __nesc_temp = EBUSY;
  return __nesc_temp;
}
}
}
  ...
  ArbiterP_0_ResourceRequested_requested(ArbiterP_0_resId);
{
  ...
  {
    unsigned char __nesc_temp = ArbiterP_0_Queue_enqueue(id);
    return __nesc_temp;
  }
}
...
{
{
  ...
  {
    unsigned char __nesc_temp = id;
    return __nesc_temp;
  }
  }
{
  unsigned char __nesc_temp = FcfsResourceQueueC_0_NO_ENTRY;
  return __nesc_temp;
}
}
}
...
inline static cc2420_header_t *CC2420PacketP_CC2420PacketBody_getHeader(message_t *msg) 
{
  return ( cc2420_header_t * )((( uint8_t * )(msg) + ( size_t )(&_IE1->data)) - sizeof( cc2420_header_t ));
}
...
{
{
  __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
{
  unsigned int __nesc_temp = CC2420ControlP_m_pan;
{
  __nesc_atomic_end(__nesc_atomic);
  return __nesc_temp;
}
  ...
  __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
{
  ...
  {
  {
    unsigned char __nesc_temp = ECANCEL;
  {
    __nesc_atomic_end(__nesc_atomic);
    return __nesc_temp;
  }
...
inline static void CC2420ActiveMessageP_SubBackoff_requestCca(message_t *msg) 
{
  CC2420ActiveMessageP_RadioBackoff_requestCca(__nesc_ntoh_leuint8(( cc2420_header_t * )((( uint8_t * )(msg) + ( size_t )(&_IE1->data)) - sizeof( cc2420_header_t ))->type.data), msg);
}
  ...
  __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
{
  ...
  {
  {
    unsigned char __nesc_temp = status;
  {
    __nesc_atomic_end(__nesc_atomic);
    return __nesc_temp;
  }
  ...
  __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
{
  for(i = 0; i < 4; i++)
  {
    if(UniqueReceiveP_receivedMessages[i].source == msgSource)
    {
      ...
      {
      {
        unsigned char __nesc_temp = TRUE;
      {
        __nesc_atomic_end(__nesc_atomic);
        return __nesc_temp;
      }
...
{
{
  __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
{
  unsigned char __nesc_temp = CC2420ControlP_addressRecognition;
{
  __nesc_atomic_end(__nesc_atomic);
  return __nesc_temp;
}
...
inline static void CC2420ReceiveP_receiveDone_task_runTask( void ) 
{
  ...
  uint8_t tmpLen = sizeof( message_t ) - (( size_t )(&_IE1->data) - sizeof( cc2420_header_t ));
...
{
{
  unsigned char __nesc_temp = CC2420SpiP_m_holder == id;
  return __nesc_temp;
}
}
...
{
{
  unsigned char __nesc_temp = CC2420ControlP_hwAutoAckDefault;
  return __nesc_temp;
}
}
...
{
{
  unsigned char __nesc_temp = CC2420ControlP_autoAckEnabled;
  return __nesc_temp;
}
}
...
inline static void CC2420ActiveMessageP_SubBackoff_requestInitialBackoff(message_t *msg) 
{
  CC2420ActiveMessageP_RadioBackoff_requestInitialBackoff(__nesc_ntoh_leuint8(( cc2420_header_t * )((( uint8_t * )(msg) + ( size_t )(&_IE1->data)) - sizeof( cc2420_header_t ))->type.data), msg);
}
  ...
  __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
{
  CC2420ControlP_CSN_set();
{
  unsigned char __nesc_temp = CC2420ControlP_SpiResource_release();
{
  __nesc_atomic_end(__nesc_atomic);
  return __nesc_temp;
}
...
{
{
  unsigned char __nesc_temp = ((_U0CTL & 0x20) && (_U0CTL & 0x04)) && (_U0CTL & 0x01);
  return __nesc_temp;
}
}
...
{
{
  __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
{
  unsigned int __nesc_temp = CC2420ControlP_m_short_addr;
{
  __nesc_atomic_end(__nesc_atomic);
  return __nesc_temp;
}
...
{
{
  ...
  {
    unsigned char __nesc_temp = ArbiterP_0_NO_RES;
    return __nesc_temp;
  }
{
  unsigned char __nesc_temp = ArbiterP_0_resId;
  return __nesc_temp;
}
}
}
