...
static void Msp430TimerP_0_Event_default_fired(uint8_t arg_0x15734f0) ;
...
static void Msp430TimerP_0_Event_fired(uint8_t arg_0x15734f0) ;
...
inline static void Msp430Adc12ImplP_TimerA_overflow( void ) ;

inline static void Msp430Adc12ImplP_CompareA0_fired( void ) ;

inline static void Msp430Adc12ImplP_CompareA1_fired( void ) ;
...
static inline void Msp430TimerP_0_Event_fired(uint8_t arg_0x15734f0) 
{
  switch (arg_0x15734f0) 
  {
    ...
    case 5:
      ...
      break;
    default :
      Msp430TimerP_0_Event_default_fired(arg_0x15734f0);
      break;
  }
...
inline static Msp430TimerCapComP_0_cc_t Msp430TimerCapComP_0_int2CC(uint16_t x) 
{
  union Msp430TimerCapComP_0___nesc_unnamed4300  {
  uint16_t f;
...
inline static Msp430TimerCapComP_1_cc_t Msp430TimerCapComP_1_int2CC(uint16_t x) 
{
  union Msp430TimerCapComP_1___nesc_unnamed4301  {
  uint16_t f;
...
inline static Msp430TimerCapComP_2_cc_t Msp430TimerCapComP_2_int2CC(uint16_t x) 
{
  union Msp430TimerCapComP_2___nesc_unnamed4302  {
  uint16_t f;
...
{
  unsigned char __nesc_temp = RoundRobinResourceQueueC_0_NO_ENTRY;
  return __nesc_temp;
}
}
}
...
{
  const struct __nesc_unnamed4267  *result;
...
inline static void HplAdc12P_HplAdc12_setMCtl(uint8_t i, adc12memctl_t memControl) 
{
  uint8_t *memCtlPtr = ( uint8_t * )(_ADC12MCTL0);
  memCtlPtr += i;
  ...
  __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
{
  if(Msp430Adc12ImplP_ADCArbiterInfo_userId() == id)
  {
    ...
    {
      unsigned char __nesc_temp = EINVAL;
    {
      __nesc_atomic_end(__nesc_atomic);
      return __nesc_temp;
    }
...
{
{
  ...
  {
    unsigned char __nesc_temp = SimpleArbiterP_0_NO_RES;
    return __nesc_temp;
  }
{
  unsigned char __nesc_temp = SimpleArbiterP_0_resId;
  return __nesc_temp;
}
}
}
...
{
  unsigned char __nesc_temp = SimpleArbiterP_0_Queue_enqueue(id);
{
  __nesc_atomic_end(__nesc_atomic);
  return __nesc_temp;
}
